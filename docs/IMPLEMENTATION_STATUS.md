...
- [x] Cloud Build configuration builds the FastAPI container from the repository root and publishes it to the Singapore `railguard` Artifact Registry repository.
